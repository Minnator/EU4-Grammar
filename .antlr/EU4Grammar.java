...
public class EU4Grammar extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DATE", "MONTHS", "LPAR", "RPAR", "LE", "EQUALS", "PLUS", "MINUS", "WHITESPACE", 
			"SINGLE_LINE_COMMENT", "IF", "ELSE", "ELSE_IF", "LIMIT", "WHILE", "SKILL_SACLED_MOD", 
			"POTENTIAL", "TRIGGER", "EFFECT", "ALLOW", "CALC_TRUE_IF", "AMOUNT", 
			"DATE_KEY", "NAME", "NAMES", "COST", "TIME", "IS_TIRGGERED_ONLY", "PREREQUISITES", 
			"PREREQUISITES_SELF", "NO_OPINION_HIT", "COLOR", "CHECK_VARIABLE", "SUBTRACKT_VARIABLE", 
			"CHANGE_VARIABLE", "SET_VARIABLE", "DIVIDE_VARIABLE", "MULTIPLY_VARIABLE", 
			"EXPORT_TO_VARIABLE", "WHICH", "VALUE", "WHO", "RULER_ALLOW", "HEIR_ALLOW", 
			"CONSORT_ALLOW", "WAR_PRIORITY", "ON_BUILT", "ON_DESTORYED", "ON_CONSTRUCTION_STARTED", 
			...
			"AI_PICK_ANCESTOR", "AI_PEACE_DESIRE", "GRAPHICAL_CULTURE", "REVOLUTIONARY_COLORS", 
			"HISTORICAL_IDEA_GROUPS", "HISTORICAL_UNITS", "MONARCH_NAMES", "LEADER_NAMES", 
			"SHIP_NAMES", "ARMY_NAMES", "FLEET_NAMES", "TAX_INCOME", "NATIVE_SIZE", 
			"NATIVE_FEROCITY", "NATIVE_HOSTILENESS", "TRADE_GOODS", "CULTURE", "RELIGION", 
			"PROVINCES", "REGION", "IS_BLESSING", "SPRITE", "MONARCH_POWER", "LEVEL", 
			"DEVELOPMENT", "INLAND", "COASTAL", "TYPE", "PROVINCE_MODIFIER", "STATE_MODIFIER", 
			"GLOBAL_MODIFIER", "WAR_GOAL", "IS_VALID_FOR_SUBJECT", "ATTACKER_DISABLED_PO", 
			"HOLY_WAR", "EXCLUSIVE", "INDEPENDENCE", "COALITION", "SUPPORT_REBELS", 
			"CALL_EMPIRE_MEMBERS", "LEAGUE", "ALLOWED_IN_GOLD_PROVINCES", "INFLUENCING_FORT", 
