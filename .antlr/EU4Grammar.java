...
public class EU4Grammar extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"AI_PICK_ANCESTOR", "AI_PEACE_DESIRE", "MALE_NAMES", "FEMALE_NAMES", 
			"DYNASTY_NAMES", "PRIMARY", "COLOR1", "COLOR2", "COLOR3", "GRAPHICAL_CULTURE", 
			"REVOLUTIONARY_COLORS", "HISTORICAL_IDEA_GROUPS", "HISTORICAL_UNITS", 
			"MONARCH_NAMES", "LEADER_NAMES", "SHIP_NAMES", "ARMY_NAMES", "FLEET_NAMES", 
			"TAX_INCOME", "NATIVE_SIZE", "NATIVE_FEROCITY", "NATIVE_HOSTILENESS", 
