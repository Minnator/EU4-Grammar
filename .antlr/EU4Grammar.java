// Generated from f:/EU4 Grammar/EU4Grammar.g4 by ANTLR 4.13.1
...
public class EU4Grammar extends Lexer {
	...
	public static final int
		...
		ELSE=25, ELSE_IF=26, LIMIT=27, WHILE=28, SKILL_SACLED_MOD=29, POTENTIAL=30, 
		TRIGGER=31, EFFECT=32, ALLOW=33, CALC_TRUE_IF=34, AMOUNT=35, DATE_KEY=36, 
		NAME=37, NAMES=38, COST=39, TIME=40, IS_TIRGGERED_ONLY=41, PREREQUISITES=42, 
		PREREQUISITES_SELF=43, NO_OPINION_HIT=44, COLOR=45, CHECK_VARIABLE=46, 
		SUBTRACKT_VARIABLE=47, CHANGE_VARIABLE=48, SET_VARIABLE=49, DIVIDE_VARIABLE=50, 
		MULTIPLY_VARIABLE=51, EXPORT_TO_VARIABLE=52, WHICH=53, VALUE=54, WHO=55, 
		RULER_ALLOW=56, HEIR_ALLOW=57, CONSORT_ALLOW=58, WAR_PRIORITY=59, ON_BUILT=60, 
		ON_DESTORYED=61, ON_CONSTRUCTION_STARTED=62, ON_CONSTRUCTION_CANCELED=63, 
		ON_OBSOLETE=64, KEEP_TRIGGER=65, BUILD_TRIGGER=66, TRADE_SHARE=67, PRIVATEER_POWER=68, 
		SHARE=69, HIDDEN_EFFECT=70, HAS_OPINION_MODIFIER=71, REMOVE_OPINION=72, 
		REVERSE_REMOVE_OPINION=73, ADD_OPINION=74, REVERSE_ADD_OPINION=75, REMOVED_EFFECT=76, 
		SAME_FAITH_MODIFIER=77, TOOLTIP=78, CUSTOM_TOOLTIP=79, DESC=80, CUSTOM_TRIGGER_TOOLTIP=81, 
		NUM_OF_OWNED_PROVINCES_WITH=82, Has_GLOBAL_MODIFIER_VALUE=83, IS_IN_WAR=84, 
		HAS_OPINION=85, COUNTRY_EVENT=86, ID=87, SCOPE=88, ADD_PROVINCE_MOD=89, 
		ADD_COUNTRY_MOD=90, DURATION=91, AI=92, MODIFIER=93, CHANCE=94, AI_WILL_DO=95, 
		FACTOR=96, AI_WEIGHT=97, AI_PICK_ANCESTOR=98, AI_PEACE_DESIRE=99, ATTACKER_LEADER=100, 
		DEFENDER_LEADER=101, CASUS_BELLI=102, DEFENDERS=103, ATTACKERS=104, PARTICIPANTS=105, 
		WAR_SCORE=106, START_DATE=107, WAR_GOAL_PROVINCE=108, CONDITIONAL=109, 
		PRE_EFFECT=110, RANGE_TO=111, RANGE_FROM=112, CATEGORY=113, LEVEL_COST=114, 
		ENABLED=115, MAX_LEVEL=116, NUM_SYMBOLS=117, FLAG_COLOR=118, TEXTURES=119, 
		TEXTURE=120, FILE=121, SIZE=122, NOOFFRAMES=123, X=124, Y=125, MALE_NAMES=126, 
		FEMALE_NAMES=127, DYNASTY_NAMES=128, PRIMARY=129, COLOR1=130, COLOR2=131, 
		COLOR3=132, GRAPHICAL_CULTURE=133, REVOLUTIONARY_COLORS=134, HISTORICAL_IDEA_GROUPS=135, 
		HISTORICAL_UNITS=136, MONARCH_NAMES=137, LEADER_NAMES=138, SHIP_NAMES=139, 
		ARMY_NAMES=140, FLEET_NAMES=141, TAX_INCOME=142, NATIVE_SIZE=143, NATIVE_FEROCITY=144, 
		NATIVE_HOSTILENESS=145, TRADE_GOODS=146, CULTURE=147, RELIGION=148, PROVINCES=149, 
		REGION=150, IS_BLESSING=151, SPRITE=152, MONARCH_POWER=153, LEVEL=154, 
		DEVELOPMENT=155, INLAND=156, COASTAL=157, TYPE=158, PROVINCE_MODIFIER=159, 
		STATE_MODIFIER=160, GLOBAL_MODIFIER=161, WAR_GOAL=162, IS_VALID_FOR_SUBJECT=163, 
		ATTACKER_DISABLED_PO=164, HOLY_WAR=165, EXCLUSIVE=166, INDEPENDENCE=167, 
		COALITION=168, SUPPORT_REBELS=169, CALL_EMPIRE_MEMBERS=170, LEAGUE=171, 
		ALLOWED_IN_GOLD_PROVINCES=172, INFLUENCING_FORT=173, ONMAP=174, MAKE_OBSOLETE=175, 
		MANUFACTORY=176, BONUS_MANUFACTORY=177, BONUS_MODIFIER=178, SHOW_SEPERATE=179, 
		BOOKMARK=180, DEFAULT=181, CENTER=182, EASY_COUNTRY=183, COUNTRY=184, 
		PROVINCE=185, START=186, CAN_START=187, OBJECTIVES=188, ABILITIES=189, 
		RELIGIOUS_CONFLICTS=190, PAPACY=191, SLOT=192, GENERIC=193, HAS_COUNTRY_SHIELD=194, 
		POTENTIAL_ON_LOAD=195, ICON=196, POSITION=197, COMPLETED_BY=198, REQUIRED_MISSIONS=199, 
		PROVINCES_TO_HIGHLIGHT=200, IDENTIFIER=201, STRING_TOOLTIP=202;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DATE", "MONTHS", "DAYS", "LPAR", "RPAR", "LE", "EQUALS", "PLUS", "MINUS", 
			"COMMA", "DOT", "WHITESPACE", "SINGLE_LINE_COMMENT", "IF", "ELSE", "ELSE_IF", 
			"LIMIT", "WHILE", "SKILL_SACLED_MOD", "POTENTIAL", "TRIGGER", "EFFECT", 
			"ALLOW", "CALC_TRUE_IF", "AMOUNT", "DATE_KEY", "NAME", "NAMES", "COST", 
			"TIME", "IS_TIRGGERED_ONLY", "PREREQUISITES", "PREREQUISITES_SELF", "NO_OPINION_HIT", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'skill_scaled_modifier'", "'potential'", "'trigger'", "'effect'", "'allow'", 
			"'calc_true_if'", "'amount'", "'date'", "'name'", "'names'", "'cost'", 
			"'time'", "'is_triggered_only'", "'prerequisites'", "'prerequisites_self'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ELSE_IF", "LIMIT", "WHILE", "SKILL_SACLED_MOD", "POTENTIAL", "TRIGGER", 
			"EFFECT", "ALLOW", "CALC_TRUE_IF", "AMOUNT", "DATE_KEY", "NAME", "NAMES", 
			"COST", "TIME", "IS_TIRGGERED_ONLY", "PREREQUISITES", "PREREQUISITES_SELF", 
