...
public class EU4Grammar extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DATE", "MONTHS", "DAYS", "LPAR", "RPAR", "PLUS", "MINUS", "COMMA", "DOT", 
			"WHITESPACE", "SINGLE_LINE_COMMENT", "IF", "ELSE", "ELSE_IF", "LIMIT", 
			"WHILE", "SKILL_SACLED_MOD", "POTENTIAL", "TRIGGER", "EFFECT", "ALLOW", 
			"CALC_TRUE_IF", "AMOUNT", "DATE_KEY", "NAME", "NAMES", "TIME", "IS_TIRGGERED_ONLY", 
			"PREREQUISITES", "PREREQUISITES_SELF", "NO_OPINION_HIT", "COLOR", "CHECK_VARIABLE", 
			"SUBTRACKT_VARIABLE", "CHANGE_VARIABLE", "SET_VARIABLE", "DIVIDE_VARIABLE", 
			"MULTIPLY_VARIABLE", "EXPORT_TO_VARIABLE", "WHO", "RULER_ALLOW", "HEIR_ALLOW", 
